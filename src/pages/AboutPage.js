...
function AboutPage(props) {
    ...
    return(
        <div>
            ...
            <Content>
            <p>Hello, my name is Serge. I'm a frontend developer  with knowledge in ,JS, Express JS, Node JS, Oracle SQL, MongoDB, and React.</p>
            ...
            <p>My latest project, , is a cookbook for developers. You can check it out <a href="https://devgrub.com" target="_blank" rel="noopener noreferrer">here</a>, or on the homepage. It is built with Angular, MongoDB, Express JS, and Node JS. However, I will be rebuilding it using React in the coming months</p>
